...
#include "SurfaceMesh/IO/Generic.h"

#include "Tree.h"
#include "Fbx_IO.h"
#include "Fbx_IO_Skeleton.h"
#include "Fbx_IO_SurfaceMesh.h"
...
int main(int argc, char* argv[]){
    ...
    SurfaceMeshIOFbx(hand).read("data/maya_hand_rev9_2013.fbx");
    SkeletonIOFbx(&skeletonTree).read("data/maya_hand_rev9_2013.fbx");
